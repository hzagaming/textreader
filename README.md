...
- Multilingual sentence segmentation and per-sentence language detection
...
- Web Speech API playback with automatic per-language voice switching and voice, speed, pitch, and volume controls
...
- Localized voice previews and custom voice-setting presets
...
10. Search and filter voices, select a voice, favorite and preview it, save/apply a preset, and confirm the values persist.

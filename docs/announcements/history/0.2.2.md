...
TextReader 0.2.2 was a Phase 2 stability, responsiveness, and reading-continuity release for Chrome and Microsoft Edge.
...
- Made loading cancellable and disabled conflicting controls, navigation, and shortcuts until playback was ready.
...
This release used the browser's Web Speech API and did not add a TextReader remote TTS backend, SFX, BGM, tracking, or third-party secrets.
...
Current announcement: [TextReader 0.3.0](../../../ANNOUNCEMENT.md). Previous announcement: [TextReader 0.2.1](./0.2.1.md).
